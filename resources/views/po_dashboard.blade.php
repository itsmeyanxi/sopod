...
<div class="bg-gray-800 p-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
        ...
        <a href="{{ route('purchase_requests.index') }}" class="bg-blue-700 p-6 rounded shadow hover:bg-blue-600 transition w-full text-left block">
            <h3 class="text-white text-lg font-semibold">Pending PR</h3>
            <p class="text-4xl text-white font-bold mt-2">{{ $pendingPRs }}</p>
        ...
        <a href="{{ route('purchase_orders.index') }}" class="bg-yellow-700 p-6 rounded shadow hover:bg-yellow-600 transition w-full text-left block">
            ...
            <p class="text-4xl text-white font-bold mt-2">{{ $pendingPOs }}</p>
        ...
        <a href="{{ route('request_for_payments.index') }}" class="bg-purple-700 p-6 rounded shadow hover:bg-purple-600 transition w-full text-left block">
            <h3 class="text-white text-lg font-semibold">Pending RFP</h3>
            <p class="text-4xl text-white font-bold mt-2">{{ $pendingRFPs }}</p>
        ...
        <a href="{{ route('accounts_payable_invoices.index') }}" class="bg-orange-700 p-6 rounded shadow hover:bg-orange-600 transition w-full text-left block">
            <h3 class="text-white text-lg font-semibold">Pending APV</h3>
            <p class="text-4xl text-white font-bold mt-2">{{ $pendingAPVs }}</p>
        ...
        <a href="{{ route('check_vouchers.index') }}" class="bg-green-700 p-6 rounded shadow hover:bg-green-600 transition w-full text-left block">
            <h3 class="text-white text-lg font-semibold">Pending CV</h3>
            <p class="text-4xl text-white font-bold mt-2">{{ $pendingCVs }}</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
        ...
        <div class="bg-gray-700 p-6 shadow rounded">
            <a href="{{ route('purchase_requests.index') }}" class="text-white text-xl font-semibold mb-2 block">
                Purchase Requests
            </a>
            <p class="text-gray-300 mb-4 text-sm">Create and manage PRs...</p>
            <a href="{{ route('purchase_requests.index') }}" class="text-gray-300 text-sm hover:underline">View all</a>
        </div>

        <div class="bg-gray-700 p-6 shadow rounded">
            <a href="{{ route('purchase_orders.index') }}" class="text-white text-xl font-semibold mb-2 block">
                Purchase Orders
            </a>
            <p class="text-gray-300 mb-4 text-sm">Track purchase orders...</p>
            <a href="{{ route('purchase_orders.index') }}" class="text-gray-300 text-sm hover:underline">View all</a>
        </div>

        <div class="bg-gray-700 p-6 shadow rounded">
            <a href="{{ route('request_for_payments.index') }}" class="text-white text-xl font-semibold mb-2 block">
                Request for Payments
            </a>
            <p class="text-gray-300 mb-4 text-sm">Manage payment requests...</p>
            <a href="{{ route('request_for_payments.index') }}" class="text-gray-300 text-sm hover:underline">View all</a>
        </div>

        <div class="bg-gray-700 p-6 shadow rounded">
            <a href="{{ route('accounts_payable_invoices.index') }}" class="text-white text-xl font-semibold mb-2 block">
                AP Invoices
            </a>
            <p class="text-gray-300 mb-4 text-sm">Manage payable invoices...</p>
            <a href="{{ route('accounts_payable_invoices.index') }}" class="text-gray-300 text-sm hover:underline">View all</a>
        </div>

        <div class="bg-gray-700 p-6 shadow rounded">
            <a href="{{ route('check_vouchers.index') }}" class="text-white text-xl font-semibold mb-2 block">
                Check Vouchers
            </a>
            <p class="text-gray-300 mb-4 text-sm">Manage check vouchers...</p>
            <a href="{{ route('check_vouchers.index') }}" class="text-gray-300 text-sm hover:underline">View all</a>
        </div>
    ...
    <div class="bg-gray-800 shadow rounded p-6">
                                ...
                                <td class="px-4 py-2">
                                    <span class="px-2 py-1 rounded-full text-xs
                                        {{ $activity->type === 'Purchase Request' ? 'bg-blue-100 text-blue-600' :
                                           ...
                                           ($activity->type === 'Supplier' ? 'bg-teal-100 text-teal-600' : 'bg-gray-700 text-gray-300'))))) }}">
                                        {{ $activity->type }}
                                    </span>
                                </td>
                            </tr>
        ...
        <div class="text-center mt-4">
            <a href="{{ route('recent_activities.index', ['module' => 'po']) }}"
               class="bg-gray-700 hover:bg-gray-700 text-white px-4 py-2 rounded">
                View All
            </a>
        </div>
    </div>

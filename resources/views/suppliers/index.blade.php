            ...
            <table class="min-w-full bg-gray-900 border border-gray-700">
                <thead>
                    <tr class="bg-gray-700">
                        <th class="px-4 py-2 border-b border-gray-700 text-left text-gray-300">Supplier Code</th>
                        ...
                        <th class="px-4 py-2 border-b border-gray-700 text-left text-gray-300">TIN</th>
                ...
                <tbody>
                    @forelse($suppliers as $supplier)
                        <tr class="hover:bg-gray-700 transition">
                            <td class="px-4 py-2 border-b border-gray-700 text-gray-300">{{ $supplier->supplier_code }}</td>
                            <td class="px-4 py-2 border-b border-gray-700 text-gray-300">{{ $supplier->supplier_name }}</td>
                            ...
                            <td class="px-4 py-2 border-b border-gray-700 text-gray-300">{{ $supplier->tin ?? 'N/A' }}</td>

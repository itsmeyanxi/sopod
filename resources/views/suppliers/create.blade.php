    ...
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        ...
        <form action="{{ route('suppliers.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea name="address" rows="3" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500">{{ old('address') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="terms" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('terms') }}" placeholder="e.g. Net 30, COD, 60 days">
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="email" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('email') }}" placeholder="Separate multiple with comma">
                </div>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="tin" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('tin') }}">
            </div>
            ...
            <div class="mb-6 bg-gray-50 border border-gray-200 rounded p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" name="bank" class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('bank') }}" placeholder="e.g., BPI, BDO, Metrobank">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="account_number" class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('account_number') }}">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 bg-gray-50 border border-gray-200 rounded p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label class="block font-semibold text-gray-500 mb-2">BANK:</label>
                        <input type="text" name="bank2" class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('bank2') }}" placeholder="e.g., BPI, BDO, Metrobank">
                    </div>
                    <div>
                        <label class="block font-semibold text-gray-500 mb-2">ACCOUNT NAME:</label>
                        <input type="text" name="account_name2" class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('account_name2') }}">
                    </div>
                    <div>
                        <label class="block font-semibold text-gray-500 mb-2">ACCOUNT NUMBER:</label>
                        <input type="text" name="account_number2" class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('account_number2') }}">
                    </div>
                </div>
            </div>
                    ...
                    <div class="file-row mb-3 bg-white border border-gray-200 rounded p-3">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div>
                                ...
                                <input type="text" name="document_names[]" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="e.g., Business Permit, BIR Certificate...">
                            </div>
                            <div>
                                <label class="block text-gray-500 text-sm mb-1">File:</label>
                                <input type="file" name="documents[]" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 text-sm" accept=".png,.jpg,.jpeg,.gif,.pdf,.doc,.docx,.xls,.xlsx">
                            </div>
                        </div>

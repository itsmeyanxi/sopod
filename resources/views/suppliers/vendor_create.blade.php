...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            <h1 class="text-2xl font-bold text-white">CREATE VENDOR</h1>
        ...
        <form action="{{ route('suppliers.vendors.store') }}" method="POST" id="vendorCreateForm">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    <label class="block text-sm font-semibold text-gray-300 mb-1">VENDOR CODE</label>
                    <input type="text" id="vendor_code_display" value="{{ old('vendor_code', $nextCode) }}" readonly
                        class="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-orange-300 font-mono focus:outline-none cursor-not-allowed">
                    <p class="text-xs text-gray-500 mt-1">Auto-generated based on category</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="name_2307" value="{{ old('name_2307') }}"
                        class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>
                <div>
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-300 mb-1">CATEGORY <span class="text-red-500">*</span></label>
                    <select name="category" id="categorySelect" required class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-orange-500">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="billing_street" value="{{ old('billing_street') }}"
                        class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-300 mb-1">BLOCK</label>
                    <input type="text" name="billing_block" value="{{ old('billing_block') }}"
                        class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-300 mb-1">BLOCK</label>
                    <input type="text" name="shipping_block" value="{{ old('shipping_block') }}"
                        class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-300 mb-1">CITY</label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="selling_price_list" value="{{ old('selling_price_list') }}"
                        class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="withholding" value="{{ old('withholding') }}"
                        class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="ee_id" value="{{ old('ee_id') }}"
                        class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-orange-500">
                </div>
                <div>
...
document.getElementById('categorySelect').addEventListener('change', function () {
    ...
    if (!cat) return;
    fetch('{{ route('suppliers.vendors.create') }}?category=' + encodeURIComponent(cat))
        .then(r => r.text())
        .then(html => {
            const parser = new DOMParser();
            const doc = parser.parseFromString(html, 'text/html');
            const newCode = doc.getElementById('vendor_code_display')?.value;
            if (newCode) document.getElementById('vendor_code_display').value = newCode;
        });
});
</script>
@endsection

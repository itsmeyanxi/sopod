...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
            ...
            <div class="bg-gray-900 border border-gray-700 rounded p-4">
                ...
                <div class="space-y-2">
                    ...
                    @if(!empty($methods))
                        ...
                        @endforeach
                    @else
                        <p class="text-gray-300">No payment methods specified</p>
                    @endif
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                <label class="block font-semibold text-gray-300 mb-1">PAYEE (Vendor/Supplier):</label>
                ...
                <table class="w-full" style="table-layout: fixed;">
                    ...
                    <thead>
                        <tr class="bg-gray-700">
                            ...
                            <th class="border border-gray-700 px-4 py-2 text-center text-gray-300 text-sm" colspan="2">Approved By:</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>

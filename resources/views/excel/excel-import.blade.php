        ...
        <div class="p-6">
            ...
            <div id="asset_classes-content" class="tab-content hidden">
                <div class="mb-6">
                    ...
                    <div class="bg-blue-100 bg-opacity-20 border border-blue-700 rounded-lg p-4">
                        <p class="text-sm text-gray-300 mb-2"><strong>Required columns (match the FA Asset Class List format):</strong></p>
                        <ul class="text-sm text-gray-300 space-y-1 ml-4">
                            ...
                            <li>• <strong>Acquisition GL Account</strong> — Used to determine asset group</li>
                        ...
                        <p class="text-xs text-gray-400 mt-3">Start data from row 4. Rows without a Code will be skipped. Existing records (matched by asset_code) will be updated.</p>
                        <p class="text-xs text-gray-400 mt-1">You can directly upload the <strong>FA Asset Class List</strong> sheet from your Fixed Asset Masterdata.xlsx file.</p>
                    </div>
                </div>

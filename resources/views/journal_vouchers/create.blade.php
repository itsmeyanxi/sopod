...
<div class="container mx-auto">
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-200 pb-4">
            ...
            <span class="bg-gray-100 text-gray-500 px-3 py-1 rounded text-sm font-mono">{{ $nextJvNumber }}</span>
        </div>
        ...
        <form action="{{ route('journal_vouchers.store') }}" method="POST" enctype="multipart/form-data" id="jvForm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    ...
                    <input type="date" name="jv_date" value="{{ old('jv_date', date('Y-m-d')) }}" required class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="reference_no" value="{{ old('reference_no') }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm" placeholder="e.g. Bank Ref, APV No.">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <textarea name="description" rows="2" required class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm" placeholder="Describe the journal entry...">{{ old('description') }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Remarks</label>
                    <textarea name="remarks" rows="2" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm" placeholder="Additional notes...">{{ old('remarks') }}</textarea>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="prepared_by" value="{{ old('prepared_by', auth()->user()->name) }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Checked By</label>
                    <input type="text" name="checked_by" value="{{ old('checked_by') }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Approved By</label>
                    <input type="text" name="approved_by" value="{{ old('approved_by') }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
            </div>
                    ...
                    <tbody id="linesBody">
                        <tr class="jv-line">
                            ...
                            <td class="border border-gray-200 px-1 py-1">
                                <input type="text" name="lines[0][account_name]" class="acct-name w-full border-0 px-2 py-1 text-sm bg-gray-50 rounded" readonly>
                            </td>
                            <td class="border border-gray-200 px-1 py-1">
                        ...
                        <tr class="jv-line">
                            ...
                            <td class="border border-gray-200 px-1 py-1">
                                <input type="text" name="lines[1][account_name]" class="acct-name w-full border-0 px-2 py-1 text-sm bg-gray-50 rounded" readonly>
                            </td>
                            <td class="border border-gray-200 px-1 py-1">
            ...
            <div class="mb-6">
                ...
                <input type="file" name="attachment" accept=".pdf,.png,.jpg,.jpeg" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                <p class="text-xs text-gray-400 mt-1">PDF, PNG, JPG (max 5MB)</p>
            </div>

            <div class="flex justify-end gap-4">
                <a href="{{ route('journal_vouchers.index') }}" class="bg-gray-100 text-gray-800 px-6 py-2 rounded hover:bg-gray-200 transition">Cancel</a>

...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            ...
            <span class="bg-gray-700 text-gray-300 px-3 py-1 rounded text-sm font-mono">{{ $voucher->jv_number }}</span>
        </div>
        ...
        <form action="{{ route('journal_vouchers.update', $voucher->id) }}" method="POST" id="jvForm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    ...
                    <input type="date" name="jv_date" value="{{ old('jv_date', $voucher->jv_date->format('Y-m-d')) }}" required class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-sm">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="reference_no" value="{{ old('reference_no', $voucher->reference_no) }}" class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <textarea name="description" rows="2" required class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-sm">{{ old('description', $voucher->description) }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-400 mb-1">Remarks</label>
                    <textarea name="remarks" rows="2" class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-sm">{{ old('remarks', $voucher->remarks) }}</textarea>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="prepared_by" value="{{ old('prepared_by', $voucher->prepared_by) }}" class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-400 mb-1">Checked By</label>
                    <input type="text" name="checked_by" value="{{ old('checked_by', $voucher->checked_by) }}" class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-400 mb-1">Approved By</label>
                    <input type="text" name="approved_by" value="{{ old('approved_by', $voucher->approved_by) }}" class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-sm">
                </div>
            </div>
                        ...
                        <tr class="jv-line">
                            <td class="border border-gray-700 px-2 py-2" style="position:relative; overflow:visible;">
                                <div class="relative acct-search-container" style="position:relative;">
                                    <input type="text" class="acct-search w-full bg-gray-800 border-2 border-gray-600 rounded-lg px-3 py-2 pr-10 text-white placeholder-gray-500 focus:border-blue-500 focus:outline-none transition-colors" value="{{ $line->account_code }} — {{ $line->account_name }}" autocomplete="off">
                            ...
                            <td class="border border-gray-700 px-1 py-1">
                                <input type="text" name="lines[{{ $i }}][account_name]" class="acct-name w-full border-0 px-2 py-1 text-sm bg-gray-900 rounded" value="{{ $line->account_name }}" readonly>
                            </td>
                            <td class="border border-gray-700 px-1 py-1">

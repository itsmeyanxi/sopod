...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            ...
            <a href="{{ route('storages.index') }}" class="bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-600 transition">
        ...
        <form action="{{ route('storages.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block font-semibold text-gray-300 mb-2">STORAGE CODE: <span class="text-blue-700 text-xs">(Auto-Generated)</span></label>
                    ...
                    <p class="text-gray-300 text-xs mt-1">Code will be automatically generated on save</p>
                </div>
                <div>
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('storages.index') }}" class="bg-gray-700 text-white px-6 py-2 rounded hover:bg-gray-600 transition">Cancel</a>

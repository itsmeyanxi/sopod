...
<div class="container mx-auto">
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-200 pb-4">
            <h1 class="text-2xl font-bold text-gray-800">CREATE NEW STORAGE</h1>
            <a href="{{ route('storages.index') }}" class="bg-gray-100 text-gray-800 px-4 py-2 rounded hover:bg-gray-200 transition">
        ...
        <form action="{{ route('storages.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <div class="flex items-center gap-2">
                        <input type="text" id="storage_code_display" class="flex-1 bg-gray-100 border border-gray-300 rounded px-3 py-2 text-gray-800 focus:outline-none cursor-not-allowed" placeholder="Will be auto-generated" readonly>
                ...
                <div>
                    ...
                    <input type="text" name="storage_name" id="storage_name" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('storage_name') }}" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="location" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('location') }}" placeholder="e.g., Building A, Floor 2">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="number" name="capacity" step="0.01" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('capacity') }}" placeholder="e.g., 10000.00">
                </div>
            </div>

            <div class="mb-6">
                <label class="block font-semibold text-gray-500 mb-2">DESCRIPTION:</label>
                <textarea name="description" rows="3" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500">{{ old('description') }}</textarea>
            </div>

            <div class="flex justify-end gap-4">
                <a href="{{ route('storages.index') }}" class="bg-gray-100 text-gray-800 px-6 py-2 rounded hover:bg-gray-200 transition">Cancel</a>

    ...
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            <div>
                ...
                <p class="text-gray-400 text-sm">Code: <span class="font-mono font-semibold">{{ $storage->storage_code }}</span></p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div class="bg-gray-900 rounded-lg p-4 border border-gray-700">
                <h3 class="text-lg font-semibold text-purple-400 mb-4">Details</h3>
                <div class="space-y-3">
                    <div>
                        <p class="text-gray-400 text-sm">Warehouse</p>
                    ...
                    <div>
                        <p class="text-gray-400 text-sm">Temperature Controlled</p>
                        <span class="inline-block px-2 py-1 rounded text-xs {{ $storage->temperature_controlled === 'Yes' ? 'bg-blue-900/50 text-blue-300' : 'bg-gray-700 text-gray-300' }}">
            ...
            <div class="bg-gray-900 rounded-lg p-4 border border-gray-700">
                <h3 class="text-lg font-semibold text-purple-400 mb-4">Status</h3>
                <div class="space-y-3">
                    <div>
                        <p class="text-gray-400 text-sm">Status</p>
                        <span class="inline-block px-2 py-1 rounded text-xs {{ $storage->isActive() ? 'bg-green-900/50 text-green-300' : 'bg-red-900/50 text-red-300' }}">
        ...
        <div class="bg-gray-900 rounded-lg p-4 border border-gray-700 mb-6">
            <h3 class="text-lg font-semibold text-purple-400 mb-3">Description</h3>
            <p class="text-gray-300 whitespace-pre-wrap">{{ $storage->description }}</p>
        </div>
        @endif

...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-white">LIQUIDATION FORMS</h1>
            ...
            <table class="w-full border-collapse border border-gray-700">
                <thead class="bg-gray-700 text-gray-300 uppercase text-sm">
                    <tr>
                        ...
                        <th class="border border-gray-700 px-4 py-3">TOTAL AMOUNT</th>
                        <th class="border border-gray-700 px-4 py-3">LINKED CAR</th>
                ...
                <tbody class="text-gray-300">
                    @forelse($liquidations as $liquidation)
                        <tr class="hover:bg-gray-700/40">
                            ...
                            <td class="border border-gray-700 px-4 py-3">{{ $liquidation->name }}</td>
                            <td class="border border-gray-700 px-4 py-3">{{ $liquidation->department }}</td>
                            <td class="border border-gray-700 px-4 py-3 text-right">&#8369;{{ number_format($liquidation->total_amount_spent, 2) }}</td>
                            ...
                            <td class="border border-gray-700 px-4 py-3">{{ $liquidation->date_applied->format('M d, Y') }}</td>
                            <td class="border border-gray-700 px-4 py-3">
                            ...
                            <td class="border border-gray-700 px-4 py-3">{{ $liquidation->creator->name ?? 'N/A' }}</td>
                            <td class="border border-gray-700 px-4 py-3">

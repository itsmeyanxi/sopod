            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="text" name="asset_class" value="{{ old('asset_class') }}" required
                           class="w-full bg-gray-700 text-gray-200 border border-gray-600 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="e.g. Delivery Trucks">
                </div>
            </div>

                        ...
                        <tbody>
                            ...
                            <tr class="hover:bg-gray-700 border-b border-gray-700">
                                <td class="border border-gray-700 px-4 py-2">
                                    <a href="{{ route('accounts_payable_invoices.show', $invoice->id) }}" class="text-blue-400 hover:text-blue-300 hover:underline font-mono">
                                        {{ $invoice->apv_no }}
                                    </a>
                                </td>
                                ...
                                <td class="border border-gray-700 px-4 py-2">
                                    <span class="bg-red-700 text-white px-3 py-1 rounded text-sm">{{ ucfirst($invoice->status) }}</span>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
function downloadExport(url) {
    ...
    .then(blob => {
        ...
        link.download = url.includes('export-summary')

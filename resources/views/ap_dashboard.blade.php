...
<div class="container mx-auto">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-white rounded-lg shadow p-5">
            <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Invoice Pipeline</h3>
            <div class="space-y-3">
                <div class="flex justify-between items-center">
                    <span class="text-gray-600 text-sm">Pending DH Approval</span>
                    <span class="bg-yellow-100 text-yellow-700 px-3 py-1 rounded text-sm font-bold">{{ $pipeline['pending_dh'] }}</span>
                </div>
                <div class="flex justify-between items-center">
                    <span class="text-gray-600 text-sm">Pending Accounting</span>
            ...
            <div class="mt-4 pt-3 border-t border-gray-200">
                <div class="flex justify-between items-center">
                    <span class="text-gray-600 text-sm">Open Debit Memos</span>
        ...
        <!-- Top 5 Suppliers -->
        <div class="bg-white rounded-lg shadow p-5">
            <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Top 5 Suppliers</h3>
            <div class="space-y-3">
                @forelse($topSuppliers as $sup)
                <div class="flex justify-between items-center">
                    <span class="text-gray-700 text-sm truncate mr-2" title="{{ $sup->vendor_name }}">{{ Str::limit($sup->vendor_name, 25) }}</span>
        ...
        <!-- Quick Links -->
        <div class="bg-white rounded-lg shadow p-5">
            <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Quick Links</h3>
            <div class="space-y-2">
                <a href="{{ route('ap_reports.aging') }}" class="block px-4 py-2 bg-gray-50 rounded hover:bg-gray-100 text-gray-700 text-sm transition">
                    <i class="fas fa-clock mr-2 text-blue-500"></i> Aging Report
                </a>
                <a href="{{ route('ap_reports.cash_forecast') }}" class="block px-4 py-2 bg-gray-50 rounded hover:bg-gray-100 text-gray-700 text-sm transition">
    ...
    <!-- Recent Invoices -->
    <div class="bg-white rounded-lg shadow p-5">
        <h3 class="text-lg font-semibold text-gray-800 mb-4 border-b border-gray-200 pb-2">Recent Invoices</h3>
        <div class="overflow-x-auto">
            <table class="w-full border-collapse text-sm">
                <thead class="bg-gray-50 text-gray-500 uppercase text-xs">
                    <tr>
                        <th class="border border-gray-200 px-4 py-2 text-left">APV No.</th>
                        <th class="border border-gray-200 px-4 py-2 text-left">Vendor</th>
                        <th class="border border-gray-200 px-4 py-2 text-center">Due Date</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="border border-gray-200 px-4 py-2 font-semibold text-blue-600">{{ $inv->apv_no }}</td>
                        <td class="border border-gray-200 px-4 py-2 text-gray-700">{{ $inv->vendor_name }}</td>
                        <td class="border border-gray-200 px-4 py-2 text-center text-gray-700">{{ $inv->due_date ? $inv->due_date->format('M d, Y') : '-' }}</td>
                        <td class="border border-gray-200 px-4 py-2 text-right font-semibold text-gray-800">{{ number_format($inv->grand_total, 2) }}</td>

    ...
    <div class="bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <form action="{{ route('debit_memos.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                    <label class="block text-gray-300 text-sm mb-1 font-medium">DM No. <span class="text-red-500">*</span></label>
                    <input type="text" name="dm_no" value="{{ old('dm_no', $dmNo) }}" class="w-full border border-gray-600 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" required>
                </div>
                <div>
                    <label class="block text-gray-300 text-sm mb-1 font-medium">Memo Date <span class="text-red-500">*</span></label>
                    <input type="date" name="memo_date" value="{{ old('memo_date', date('Y-m-d')) }}" class="w-full border border-gray-600 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" required>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="amount" value="{{ old('amount') }}" step="0.01" min="0.01" class="w-full border border-gray-600 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="0.00" required>
            </div>

            <div class="mb-4">
                <label class="block text-gray-300 text-sm mb-1 font-medium">Reason</label>
                <input type="text" name="reason" value="{{ old('reason') }}" class="w-full border border-gray-600 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="e.g., Damaged goods, Short delivery">
            </div>

            <div class="mb-6">
                <label class="block text-gray-300 text-sm mb-1 font-medium">Notes</label>
                <textarea name="notes" rows="3" class="w-full border border-gray-600 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm" placeholder="Additional notes...">{{ old('notes') }}</textarea>
            </div>

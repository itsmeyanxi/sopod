...
<div class="container mx-auto">
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6 border-b border-gray-200 pb-4">
            <h1 class="text-2xl font-bold text-gray-800">Debit Memos</h1>
        ...
        <div class="overflow-x-auto">
            <table class="w-full border-collapse text-sm">
                <thead class="bg-gray-50 text-gray-500 uppercase text-xs">
                    <tr>
                        <th class="border border-gray-200 px-4 py-3 text-left">DM No.</th>
                        <th class="border border-gray-200 px-4 py-3 text-left">Supplier</th>
                        <th class="border border-gray-200 px-4 py-3 text-left">Invoice</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="border border-gray-200 px-4 py-3 font-bold text-blue-600">
                            <a href="{{ route('debit_memos.show', $memo) }}">{{ $memo->dm_no }}</a>
                        </td>
                        <td class="border border-gray-200 px-4 py-3 text-gray-700">{{ $memo->supplier_name }}</td>
                        <td class="border border-gray-200 px-4 py-3 text-gray-500">{{ $memo->invoice_no ?? '-' }}</td>
                        <td class="border border-gray-200 px-4 py-3 text-center text-gray-700">{{ $memo->memo_date->format('M d, Y') }}</td>
                        <td class="border border-gray-200 px-4 py-3 text-right font-semibold text-gray-800">{{ number_format($memo->amount, 2) }}</td>
                        <td class="border border-gray-200 px-4 py-3 text-gray-600">{{ Str::limit($memo->reason, 30) }}</td>
                        ...
                        <td class="border border-gray-200 px-4 py-3 text-center">
                            <div class="flex justify-center gap-2">
                                <a href="{{ route('debit_memos.show', $memo) }}" class="text-gray-600 hover:text-gray-800 text-xs">

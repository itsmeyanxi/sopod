    ...
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
                ...
                <p class="px-4 py-2 bg-gray-50 border border-gray-200 rounded text-gray-700">{{ $reimbursement->department }}</p>
            </div>
            <div>
                <label class="block font-semibold text-gray-500 mb-1">DATE APPLIED:</label>
                <p class="px-4 py-2 bg-gray-50 border border-gray-200 rounded text-gray-700">{{ $reimbursement->date_applied->format('F d, Y') }}</p>
            </div>
        </div>
                ...
                <table class="w-full border-collapse border border-gray-200">
                    <thead class="bg-gray-100 text-gray-500 uppercase text-sm">
                        <tr>
                            ...
                            <th class="border border-gray-200 px-4 py-3" style="width: 55%;">PARTICULARS</th>
                            <th class="border border-gray-200 px-4 py-3" style="width: 25%;">COST</th>
                        </tr>
                    </thead>
                    <tbody class="text-gray-500">
                        @foreach($reimbursement->items as $item)
                            <tr class="hover:bg-gray-100/40">
                                <td class="border border-gray-200 px-4 py-3">{{ $item->date ? \Carbon\Carbon::parse($item->date)->format('M d, Y') : '' }}</td>
                                <td class="border border-gray-200 px-4 py-3">{{ $item->particulars }}</td>
                                <td class="border border-gray-200 px-4 py-3 text-right">&#8369;{{ number_format($item->cost, 2) }}</td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
                        <tr class="bg-gray-50">
                            ...
                            <td class="border border-gray-200 px-4 py-3 text-right font-bold text-green-700 text-lg">&#8369;{{ number_format($reimbursement->total_amount_spent, 2) }}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
        ...
        <div class="mb-6">
            ...
            <p class="px-4 py-2 bg-gray-50 border border-gray-200 rounded text-gray-700">{{ $reimbursement->submitted_by ?? 'N/A' }}</p>
        </div>
        ...
        <div class="mb-6">
            ...
            <p class="px-4 py-2 bg-gray-50 border border-gray-200 rounded text-gray-700">{{ $reimbursement->creator->name ?? 'N/A' }}</p>
        </div>
                    ...
                    <tbody>
                        <tr>
                            <td class="border border-gray-200 px-4 py-8 text-center align-bottom">
                                <span class="text-gray-800 font-semibold text-sm">{{ $reimbursement->submitted_by ?? ($reimbursement->creator->name ?? '') }}</span>
                            </td>
                            <td class="border border-gray-200 px-4 py-8 text-center align-bottom">
                                <span class="text-gray-800 font-semibold text-sm">{{ $reimbursement->departmentHeadApprover->name ?? '' }}</span>
                            ...
                            <td class="border border-gray-200 px-4 py-8 text-center align-bottom">
                                <span class="text-gray-800 font-semibold text-sm">{{ $reimbursement->executiveApprover->name ?? '' }}</span>
                        ...
                        <tr class="bg-gray-100 text-gray-500 text-xs italic">
                            ...
                            <td class="border border-gray-200 px-4 py-2 text-center">President / Vice President</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<div id="approveExecutiveModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-96">
        <h3 class="text-xl font-bold text-gray-800 mb-4">Approve as Executive (President/Vice President)</h3>
...
<div id="rejectModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-96">
        <h3 class="text-xl font-bold text-gray-800 mb-4">Reject Reimbursement Form</h3>

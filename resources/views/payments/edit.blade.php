...
<div class="container mx-auto max-w-3xl">
    <div class="mb-4">
        <a href="{{ route('payments.show', $payment->id) }}" class="text-sm text-gray-500 hover:text-gray-700">
        ...
        <form action="{{ auth()->user()->canEditPayments() ? route('payments.update', $payment->id) : route('payments.submitEditRequest', $payment->id) }}" method="POST" class="p-6" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="collection_receipt_number"
                        ...
                        class="w-full bg-gray-50 border border-gray-200 rounded-md p-2.5 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                        required>
                </div>
            ...
            <div class="mt-4">
                ...
                <textarea name="payment_notes" rows="2"
                    class="w-full bg-gray-50 border border-gray-200 rounded-md p-2.5 text-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('payment_notes', $payment->payment_notes) }}</textarea>
            </div>
            ...
            <div class="mt-4">
                ...
                <input type="file" name="attachment"
                    ...
                    class="w-full bg-gray-50 border border-gray-200 rounded-md p-2 text-gray-700 text-sm file:mr-3 file:py-1.5 file:px-4 file:rounded file:border-0 file:text-sm file:font-medium file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
            ...
            <div class="mt-6 flex items-center gap-3">
                ...
                <a href="{{ route('payments.show', $payment->id) }}" class="bg-gray-200 hover:bg-gray-300 text-gray-700 px-6 py-2.5 rounded-md font-medium transition">
                    Cancel
                </a>
            </div>
        </form>

    ...
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        ...
        <form action="{{ route('issue_slips.update', $issueSlip->id) }}" method="POST">
                    ...
                    <table class="w-full border-collapse border border-gray-700" id="itemsTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border border-gray-700 px-2 py-2">
                                    <input type="number" step="0.0001" name="items[{{ $index }}][net_weight]" class="w-full px-2 py-1 bg-gray-900 border border-gray-700 rounded text-white text-center" value="{{ $item->net_weight }}">
                                </td>
                                <td class="border border-gray-700 px-2 py-2">
                                    <input type="number" step="0.0001" name="items[{{ $index }}][actual_weight]" class="w-full px-2 py-1 bg-gray-900 border border-gray-700 rounded text-white text-center" value="{{ $item->actual_weight }}">
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('issue_slips.show', $issueSlip->id) }}" class="bg-gray-700 text-white px-6 py-2 rounded hover:bg-gray-700 transition">Cancel</a>

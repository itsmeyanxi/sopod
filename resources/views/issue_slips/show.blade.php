    ...
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            ...
            <div class="flex gap-3">
                ...
                <a href="{{ route('issue_slips.index') }}" class="bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-600">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="space-y-2">
                ...
                <p class="text-gray-400"><span class="font-semibold text-gray-300">Destination:</span> {{ $issueSlip->destination ?? $issueSlip->customer_name ?? 'N/A' }}</p>
                <p class="text-gray-400"><span class="font-semibold text-gray-300">Created By:</span> {{ $issueSlip->creator->name ?? 'N/A' }}</p>
            </div>
        </div>

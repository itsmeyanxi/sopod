...
<div class="container mx-auto">
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-200 pb-4">
            <h1 class="text-2xl font-bold text-gray-800">ISSUE SLIPS</h1>
        ...
        <form method="GET" class="mb-4 flex flex-wrap gap-3 items-end">
            ...
            <a href="{{ route('issue_slips.index') }}" class="bg-gray-100 text-gray-800 px-4 py-2 rounded hover:bg-gray-100 text-sm">Clear</a>
        </form>
        ...
        <div class="overflow-x-auto">
            <table class="w-full border-collapse border border-gray-200">
                <thead class="bg-red-700 text-white">
                    <tr>
                        <th class="border border-gray-200 px-3 py-2 text-left">IS NUMBER</th>
                        <th class="border border-gray-200 px-3 py-2 text-left">DATE</th>
                        <th class="border border-gray-200 px-3 py-2 text-left">ORIGIN</th>
                        <th class="border border-gray-200 px-3 py-2 text-left">BRANCH</th>
                        <th class="border border-gray-200 px-3 py-2 text-left">SO NUMBER</th>
                        <th class="border border-gray-200 px-3 py-2 text-left">DESTINATION</th>
                        <th class="border border-gray-200 px-3 py-2 text-left">CREATED BY</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-100">
                        ...
                        <td class="border border-gray-200 px-3 py-2">{{ $is->branch ?? optional($is->salesOrder)->branch ?? optional(optional($is->salesOrder)->customer)->branch ?? '-' }}</td>
                        <td class="border border-gray-200 px-3 py-2">{{ $is->sales_order_number }}</td>
                        <td class="border border-gray-200 px-3 py-2">{{ $is->destination ?? $is->customer_name }}</td>
                        <td class="border border-gray-200 px-3 py-2">{{ $is->creator->name ?? '-' }}</td>

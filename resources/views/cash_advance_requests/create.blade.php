...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        ...
        <form action="{{ route('cash_advance_requests.store') }}" method="POST">
            @csrf
            ...
            <!-- Purpose -->
            <div class="mb-6">
                <label class="block font-semibold text-gray-300 mb-2">PURPOSE: <span class="text-red-400">*</span></label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block font-semibold text-gray-300 mb-2">DATE REQUESTED: <span class="text-red-400">*</span></label>
                ...
                <div>
                    <label class="block font-semibold text-gray-300 mb-2">DATE NEEDED: <span class="text-red-400">*</span></label>
            ...
            <div class="mb-6">
                <label class="block font-semibold text-gray-300 mb-2">AMOUNT ADVANCED: <span class="text-red-400">*</span></label>
                <div class="relative">
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('cash_advance_requests.index') }}" class="bg-gray-700 text-white px-6 py-2 rounded hover:bg-gray-600 transition">
                    Cancel
                </a>

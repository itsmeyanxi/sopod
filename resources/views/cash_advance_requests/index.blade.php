        ...
        <div class="overflow-x-auto">
            <table class="w-full border-collapse border border-gray-200">
                <thead class="bg-gray-100 text-gray-500 uppercase text-sm">
                    <tr>
                        <th class="border border-gray-200 px-4 py-3">CAR NO</th>
                        ...
                        <th class="border border-gray-200 px-4 py-3">DATE REQUESTED</th>
                ...
                <tbody class="text-gray-500">
                    @forelse($cars as $car)
                        <tr class="hover:bg-gray-100/40">
                            <td class="border border-gray-200 px-4 py-3">{{ $car->car_no }}</td>
                            <td class="border border-gray-200 px-4 py-3">{{ $car->payee }}</td>
                            <td class="border border-gray-200 px-4 py-3">{{ $car->department }}</td>
                            <td class="border border-gray-200 px-4 py-3 text-right">&#8369;{{ number_format($car->amount, 2) }}</td>
                            <td class="border border-gray-200 px-4 py-3">{{ $car->date_requested ? $car->date_requested->format('M d, Y') : 'N/A' }}</td>
                            ...
                            <td class="border border-gray-200 px-4 py-3">{{ $car->creator->name ?? 'N/A' }}</td>
                            <td class="border border-gray-200 px-4 py-3">

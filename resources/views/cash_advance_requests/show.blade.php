                ...
                <table class="w-full" style="table-layout: fixed;">
                    ...
                    <thead>
                        <tr class="bg-gray-100">
                            <th class="border border-gray-200 px-4 py-2 text-center text-gray-500 text-sm">Requested By:</th>
                    ...
                    <tbody>
                        <tr>
                            <td class="border border-gray-200 px-4 py-8 text-center align-bottom">
                                <span class="text-gray-800 font-semibold text-sm">{{ $car->creator->name ?? '' }}</span>
                            </td>
                            <td class="border border-gray-200 px-4 py-8 text-center align-bottom">
                        ...
                        <tr class="bg-gray-100 text-gray-500 text-xs italic">
                            ...
                            <td class="border border-gray-200 px-4 py-2 text-center">Executive (President / VP / CFO)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<div id="approveExecutiveModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-96">
        <h3 class="text-xl font-bold text-gray-800 mb-4">Approve as Executive (President / VP / CFO)</h3>
...
<div id="rejectModal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-96">
        <h3 class="text-xl font-bold text-gray-800 mb-4">Reject Cash Advance Request</h3>

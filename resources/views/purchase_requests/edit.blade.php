    ...
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        ...
        <form action="{{ isset($notesOnly) && $notesOnly ? route('purchase_requests.update_notes', $purchaseRequest->id) : route('purchase_requests.update', $purchaseRequest->id) }}" method="POST" id="prForm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="department" class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('department', $purchaseRequest->department) }}">
                    </div>
                    <div>
                    ...
                    <table class="border-collapse border border-gray-700" id="itemsTable" style="min-width:1400px; width:100%;">
                        ...
                        <tbody id="itemsBody" class="bg-gray-800 text-gray-300 divide-y divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-700/40">
                                ...
                                <td class="border border-gray-700 px-2 py-2">{{ $item->supplier_name ?? 'N/A' }}</td>
                                ...
                                <td class="border border-gray-700 px-2 py-2">
                                    <div class="relative">
                                        <input type="text" class="w-full px-2 py-1 bg-gray-900 border border-gray-700 rounded text-white supplier-search" placeholder="Search supplier..." autocomplete="off" value="{{ $item->supplier_name ?? '' }}">
            ...
            <div class="mb-6">
                <div class="border border-gray-700 rounded">
                    <table class="w-full">
                        ...
                        <tbody>
                            <tr>
                                <td class="border border-gray-700 px-4 py-4 text-center text-gray-300 text-sm">{{ $purchaseRequest->creator->name ?? auth()->user()->name }}</td>
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('purchase_requests.show', $purchaseRequest->id) }}" class="bg-gray-700 text-white px-6 py-2 rounded hover:bg-gray-600 transition">
                    Cancel
                </a>
                @if(isset($notesOnly) && $notesOnly)
...
function addRow() {
    ...
    newRow.innerHTML = `
        ...
        <td class="border border-gray-700 px-2 py-2"><div class="relative"><input type="text" class="w-full px-2 py-1 bg-gray-900 border border-gray-700 rounded text-white supplier-search" placeholder="Search supplier..." autocomplete="off"><input type="hidden" name="items[${rowCount}][supplier_id]" class="supplier-id-input"><input type="hidden" name="items[${rowCount}][supplier_name]" class="supplier-name-input"><div class="supplier-dropdown hidden bg-gray-800 border border-gray-600 rounded shadow-lg max-h-40 overflow-y-auto"></div></div></td>

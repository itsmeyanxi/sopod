...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            <h1 class="text-2xl font-bold text-white">EDIT PURCHASE REQUISITION FORM</h1>
        ...
        <form action="{{ route('purchase_requests.update', $purchaseRequest->id) }}" method="POST" id="prForm">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="hidden" name="supplier" id="supplier_text" value="{{ old('supplier', $purchaseRequest->supplier) }}">
                    </div>
                    <div>
                    ...
                    <table class="w-full border-collapse border border-gray-700" id="itemsTable">
                        <thead class="bg-gray-700 text-gray-300 uppercase text-xs">
                            <tr>
                                ...
                                <th class="border border-gray-700 px-2 py-2 w-32">AMOUNT</th>
                                <th class="border border-gray-700 px-2 py-2">REMARKS/SPECIFICATIONS</th>

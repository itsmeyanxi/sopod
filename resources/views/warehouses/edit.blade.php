...
<div class="container mx-auto">
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-200 pb-4">
            ...
            <a href="{{ route('warehouses.index') }}" class="bg-gray-100 text-gray-800 px-4 py-2 rounded hover:bg-gray-100 transition">
        ...
        <form action="{{ route('warehouses.update', $warehouse->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea name="address" rows="3" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500">{{ old('address', $warehouse->address) }}</textarea>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block font-semibold text-gray-500 mb-2">EMAIL ADDRESS:</label>
                    <input type="email" name="email" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('email', $warehouse->email) }}">
                </div>
                <div>
                    <label class="block font-semibold text-gray-500 mb-2">CONTACT NUMBER:</label>
                    <input type="text" name="contact_number" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('contact_number', $warehouse->contact_number) }}">
                </div>
            </div>

            <div class="mb-6">
                <label class="block font-semibold text-gray-500 mb-2">TIN (Tax Identification Number):</label>
                <input type="text" name="tin" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('tin', $warehouse->tin) }}">
            </div>

            <!-- Status -->
            <div class="mb-6">
                <label class="block font-semibold text-gray-500 mb-2">STATUS:</label>
                <select name="status" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500">
            ...
            <div class="mb-6 bg-gray-50 border border-gray-200 rounded p-4">
                <h3 class="font-semibold text-gray-800 mb-4">BANK INFORMATION</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label class="block font-semibold text-gray-500 mb-2">BANK:</label>
                        <input type="text" name="bank" class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('bank', $warehouse->bank) }}" placeholder="e.g., BPI, BDO, Metrobank">
                    </div>
                    <div>
                        <label class="block font-semibold text-gray-500 mb-2">ACCOUNT NAME:</label>
                        <input type="text" name="account_name" class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('account_name', $warehouse->account_name) }}">
                    </div>
                    <div>
                        <label class="block font-semibold text-gray-500 mb-2">ACCOUNT NUMBER:</label>
                        <input type="text" name="account_number" class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('account_number', $warehouse->account_number) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 bg-gray-50 border border-gray-200 rounded p-4">
                <h3 class="font-semibold text-gray-800 mb-4"><i class="fas fa-folder-open mr-2"></i>EXISTING DOCUMENTS</h3>
                <div class="space-y-2">
            ...
            <!-- Add New Documents -->
            <div class="mb-6 bg-gray-50 border border-gray-200 rounded p-4">
                <h3 class="font-semibold text-gray-800 mb-4"><i class="fas fa-plus-circle mr-2"></i>ADD NEW DOCUMENTS</h3>
                <div id="fileInputs">
                    <div class="file-row mb-3 bg-white border border-gray-200 rounded p-3">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div>
                                ...
                                <input type="text" name="document_names[]" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-purple-500" placeholder="e.g., Business Permit, Contract...">
                            </div>
                            <div>
...
function addFileInput() {
    ...
    div.innerHTML = `
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div>
                <label class="block text-gray-500 text-sm mb-1">Document Label:</label>
                <input type="text" name="document_names[]" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 text-sm" placeholder="e.g., Business Permit...">
            </div>
            <div>
                <label class="block text-gray-500 text-sm mb-1">File:</label>
                <input type="file" name="documents[]" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 text-sm" accept=".png,.jpg,.jpeg,.gif,.pdf,.doc,.docx,.xls,.xlsx">

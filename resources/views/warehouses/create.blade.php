    ...
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        ...
        <form action="{{ route('warehouses.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block font-semibold text-gray-300 mb-2">WAREHOUSE CODE: <span class="text-blue-700 text-xs">(Auto-Generated)</span></label>
            ...
            <div class="mb-6 bg-gray-900 border border-gray-700 rounded p-4">
                ...
                <p class="text-gray-300 text-sm mb-4">Upload permits, contracts, and other required documents.</p>
                <div id="fileInputs">

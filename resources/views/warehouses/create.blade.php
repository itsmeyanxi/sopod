...
<div class="container mx-auto">
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-200 pb-4">
            <h1 class="text-2xl font-bold text-gray-800">CREATE NEW WAREHOUSE</h1>
        ...
        <form action="{{ route('warehouses.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    <label class="block font-semibold text-gray-500 mb-2">WAREHOUSE CODE: <span class="text-blue-400 text-xs">(Auto-Generated)</span></label>
                    <div class="flex items-center gap-2">
                        <input type="text" id="warehouse_code_display" class="flex-1 bg-gray-100 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none cursor-not-allowed" placeholder="Will be auto-generated" readonly>
                ...
                <div>
                    ...
                    <input type="text" name="warehouse_name" id="warehouse_name" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('warehouse_name') }}" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                    ...
                    <input type="email" name="email" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('email') }}">
                </div>
                <div>

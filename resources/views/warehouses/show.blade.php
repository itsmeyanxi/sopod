    ...
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('warehouses.index') }}" class="bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-600 transition"><i class="fas fa-arrow-left mr-1"></i> Back</a>
            </div>
        </div>
        ...
        <div class="bg-gray-900 border border-gray-700 rounded p-4">
            ...
            <div class="space-y-2">
                ...
                <div class="flex items-center justify-between bg-gray-800 rounded px-3 py-2">
                    <span class="text-gray-300"><i class="fas fa-file mr-2 text-purple-400"></i>{{ $doc['name'] }}</span>

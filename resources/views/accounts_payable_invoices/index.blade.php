...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        ...
        <!-- Filters -->
        <div class="mb-4 bg-gray-900 border border-gray-700 rounded p-4">
            <form method="GET" class="flex items-center gap-3 flex-wrap">
                ...
                <select name="status" class="bg-gray-800 border border-gray-700 rounded px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-purple-500">

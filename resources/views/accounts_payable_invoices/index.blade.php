...
<div class="container mx-auto">
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6 border-b border-gray-200 pb-4">
            ...
            <a href="{{ route('accounts_payable_invoices.create') }}" class="bg-gradient-to-r from-purple-600 to-purple-700 text-gray-800 px-4 py-2 rounded hover:from-purple-700 hover:to-purple-800 transition">

            ...
            <div class="mb-6 bg-gray-50 border border-gray-200 rounded p-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="account_code" class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('account_code', $invoice->account_code) }}">
                    </div>
                    <div>
                        <label class="block font-semibold text-gray-500 mb-2">ACCOUNT NAME:</label>
                        <input type="text" name="account_name" class="w-full bg-white border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('account_name', $invoice->account_name) }}">
                    </div>
                </div>
            </div>

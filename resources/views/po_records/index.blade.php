...
<div class="container mx-auto">
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="flex flex-wrap gap-2 mb-6 border-b border-gray-200 pb-4">
            ...
            <a href="{{ route('po_records.index', ['type' => 'purchase_requests', 'status' => $status, 'from' => $from, 'to' => $to]) }}"
               class="px-4 py-2 rounded-t text-sm font-semibold transition
                {{ $type === 'purchase_requests' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-500 hover:bg-gray-100' }}">
                Purchase Requests
            </a>
            @endif
            ...
            <a href="{{ route('po_records.index', ['type' => 'purchase_orders', 'status' => $status, 'from' => $from, 'to' => $to]) }}"
               class="px-4 py-2 rounded-t text-sm font-semibold transition
                {{ $type === 'purchase_orders' ? 'bg-purple-600 text-white' : 'bg-gray-100 text-gray-500 hover:bg-gray-100' }}">
                Purchase Orders
            </a>
            @endif
            ...
            <a href="{{ route('po_records.index', ['type' => 'rfp', 'status' => $status, 'from' => $from, 'to' => $to]) }}"
               class="px-4 py-2 rounded-t text-sm font-semibold transition
                {{ $type === 'rfp' ? 'bg-orange-600 text-white' : 'bg-gray-100 text-gray-500 hover:bg-gray-100' }}">
                Request for Payment
            </a>
            @endif
            ...
            <a href="{{ route('po_records.index', ['type' => 'apv', 'status' => $status, 'from' => $from, 'to' => $to]) }}"
               class="px-4 py-2 rounded-t text-sm font-semibold transition
                {{ $type === 'apv' ? 'bg-teal-600 text-white' : 'bg-gray-100 text-gray-500 hover:bg-gray-100' }}">
                AP Voucher
            </a>
            @endif
            ...
            <a href="{{ route('po_records.index', ['type' => 'check_vouchers', 'status' => $status, 'from' => $from, 'to' => $to]) }}"
               class="px-4 py-2 rounded-t text-sm font-semibold transition
                {{ $type === 'check_vouchers' ? 'bg-red-600 text-white' : 'bg-gray-100 text-gray-500 hover:bg-gray-100' }}">
                Check Vouchers
            </a>
            @endif
        </div>
        ...
        <!-- Filters -->
        <form method="GET" action="{{ route('po_records.index') }}" class="mb-6 bg-gray-50 border border-gray-200 rounded p-4">
                ...
                <thead>
                    <tr class="bg-gray-100">
                        @if($type === 'purchase_requests')
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">PR No</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Company</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Requisitioner</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Supplier</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Date of Request</th>
                        ...
                        @elseif($type === 'purchase_orders')
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">PO No</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">PR No</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Company</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Supplier</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Order Date</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-center text-gray-500">Status</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Created By</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-center text-gray-500">Actions</th>
                        @elseif($type === 'rfp')
                            ...
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">PO No</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Company</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Payee</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-right text-gray-500">Amount</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Date</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-center text-gray-500">Status</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Created By</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-center text-gray-500">Actions</th>
                        @elseif($type === 'apv')
                            ...
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">RFP No</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Vendor</th>
                        ...
                        @elseif($type === 'check_vouchers')
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">CV No</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">APV No</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Supplier</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Bank</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-right text-gray-500">Check Amount</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-center text-gray-500">Status</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-left text-gray-500">Created By</th>
                            <th class="px-4 py-2 border-b border-gray-200 text-center text-gray-500">Actions</th>
                        @endif
                ...
                <tbody>
                    @forelse($records as $record)
                        <tr class="hover:bg-gray-100 transition">
                            @if($type === 'purchase_requests')
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->pr_no }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->company }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->requisitioner }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->supplier->supplier_name ?? 'N/A' }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->date_of_request }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-center">
                                    @include('po_records._status_badge', ['status' => $record->status])
                                </td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->creator->name ?? 'N/A' }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-center">
                            ...
                            @elseif($type === 'purchase_orders')
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->po_no }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->pr_no ?? 'N/A' }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->company }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->supplier ?? 'N/A' }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->order_date->format('M d, Y') }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-center">
                                    @include('po_records._status_badge', ['status' => $record->status])
                                </td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->creator->name ?? 'N/A' }}</td>
                            ...
                            @elseif($type === 'rfp')
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->rfp_no }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->purchaseOrder->po_no ?? 'N/A' }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->company }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->payee }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-right text-gray-500">{{ number_format($record->amount, 2) }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->date }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-center">
                                    @include('po_records._status_badge', ['status' => $record->status])
                                </td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->creator->name ?? 'N/A' }}</td>
                            ...
                            @elseif($type === 'apv')
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->apv_no }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->requestForPayment->rfp_no ?? 'N/A' }}</td>
                            ...
                            @elseif($type === 'check_vouchers')
                                ...
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->supplier_name }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->bank ?? 'N/A' }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-right text-gray-500">{{ number_format($record->check_amount, 2) }}</td>
                                <td class="px-4 py-2 border-b border-gray-200 text-center">
                                    @include('po_records._status_badge', ['status' => $record->status])
                                </td>
                                <td class="px-4 py-2 border-b border-gray-200 text-gray-500">{{ $record->creator->name ?? 'N/A' }}</td>

        ...
        <div class="flex flex-wrap gap-2 mb-6 border-b border-gray-700 pb-4">
            ...
            <a href="{{ route('po_records.index', ['type' => 'purchase_requests', 'status' => $status, 'from' => $from, 'to' => $to]) }}"
               class="px-4 py-2 rounded-t text-sm font-semibold transition
                {{ $type === 'purchase_requests' ? 'bg-blue-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600' }}">
                Purchase Requests
            </a>
            @endif
            ...
            <a href="{{ route('po_records.index', ['type' => 'purchase_orders', 'status' => $status, 'from' => $from, 'to' => $to]) }}"
               class="px-4 py-2 rounded-t text-sm font-semibold transition
                {{ $type === 'purchase_orders' ? 'bg-purple-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600' }}">
                Purchase Orders
            </a>
            @endif
            ...
            <a href="{{ route('po_records.index', ['type' => 'rfp', 'status' => $status, 'from' => $from, 'to' => $to]) }}"
               class="px-4 py-2 rounded-t text-sm font-semibold transition
                {{ $type === 'rfp' ? 'bg-orange-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600' }}">
                Request for Payment
            </a>
            @endif
            ...
            <a href="{{ route('po_records.index', ['type' => 'apv', 'status' => $status, 'from' => $from, 'to' => $to]) }}"
               class="px-4 py-2 rounded-t text-sm font-semibold transition
                {{ $type === 'apv' ? 'bg-teal-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600' }}">
                AP Voucher
            </a>
            @endif
            ...
            <a href="{{ route('po_records.index', ['type' => 'check_vouchers', 'status' => $status, 'from' => $from, 'to' => $to]) }}"
               class="px-4 py-2 rounded-t text-sm font-semibold transition
                {{ $type === 'check_vouchers' ? 'bg-red-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600' }}">
                Check Vouchers
            </a>
            @endif
        </div>

                    ...
                    <tr class="hover:bg-gray-800/50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <span class="px-2 py-1 rounded text-xs font-semibold
                                {{ $rr->status == 'Received' ? 'bg-green-900/30 text-green-400' : '' }}
                                {{ $rr->status == 'Processing' ? 'bg-yellow-900/30 text-yellow-400' : '' }}
                                {{ $rr->status == 'Completed' ? 'bg-blue-900/30 text-blue-400' : '' }}">
                                {{ $rr->status }}
                            </span>
                        </td>
                        <td class="px-4 py-3 text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <a href="{{ route('receiving-reports.print', $rr->id) }}" target="_blank"
                                   class="text-green-400 hover:text-green-300" title="Print">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">

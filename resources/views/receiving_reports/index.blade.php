        ...
        <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6 bg-white/50 p-4 rounded-lg">
            <div>
                ...
                <input type="date" name="date_from" value="{{ request('date_from') }}" 
                       class="w-full bg-gray-50 border border-gray-200 text-gray-700 rounded-md px-3 py-2">
            </div>
            ...
            <div>
                ...
                <select name="status" class="w-full bg-gray-50 border border-gray-200 text-gray-700 rounded-md px-3 py-2">
            ...
            <div>
                ...
                <div class="flex gap-2">
                    <input type="text" name="search" value="{{ request('search') }}" 
                           ...
                           class="flex-1 bg-gray-50 border border-gray-200 text-gray-700 rounded-md px-3 py-2">

    ...
    <div class="bg-gray-700 rounded-lg p-4 mb-6">
        <div class="flex gap-3">
            <input type="text" id="search_input" placeholder="Search by Account Code or Name..."
                class="flex-1 bg-gray-600 text-white border border-gray-500 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <form id="import_form" class="space-y-4">
            ...
            <div class="border-2 border-dashed border-gray-600 rounded-lg p-8 bg-gray-700/50 hover:bg-gray-700/70 transition cursor-pointer" id="drop_zone">
                <div class="text-center">
                    ...
                    <p class="text-gray-400 text-sm">or click to select a CSV/Excel file (max 10MB)</p>
            ...
            data.accounts.forEach(account => {
                ...
                row.innerHTML = `
                    ...
                    <td class="px-3 py-3 text-center space-x-2">
                        <a href="/accounting/gl-accounts/${account.id}" class="text-blue-400 hover:text-blue-300 text-xs">
                            <i class="fas fa-eye"></i> View
                        </a>
                        <a href="/accounting/gl-accounts/${account.id}/edit" class="text-purple-400 hover:text-purple-300 text-xs">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <button onclick="deleteAccount(${account.id})" class="text-red-400 hover:text-red-300 text-xs">

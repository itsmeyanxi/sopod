    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-gray-800 rounded-lg shadow-sm p-4 mb-4">
            <form method="GET" action="{{ route('delivery_counter_dates.index') }}" class="flex flex-wrap items-end gap-3">
                ...
                <a href="{{ route('delivery_counter_dates.index') }}" class="bg-gray-200 hover:bg-gray-300 text-gray-200 px-4 py-2 rounded-md font-medium transition">Clear</a>
                @endif
            </form>
        </div>
                    ...
                    <thead>
                        <tr class="bg-red-800 text-white">
                            <th class="px-3 py-3 text-center w-10">
                                <input type="checkbox" id="selectAllHeader" class="rounded border-gray-600">
                            </th>

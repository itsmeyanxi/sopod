            ...
            <table class="w-full text-sm border-collapse">
                <thead class="bg-gray-900 text-gray-300 uppercase text-xs">
                    <tr>
                        ...
                        <th class="border border-gray-700 px-3 py-2 text-left">Group</th>
                        <th class="border border-gray-700 px-3 py-2 text-left">Dep. Account</th>
                        <th class="border border-gray-700 px-3 py-2 text-right">Accum. Before</th>
                        <th class="border border-gray-700 px-3 py-2 text-center">Rem. Months</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-900 border-b border-gray-100">
                        <td class="border border-gray-700 px-3 py-2 text-gray-400 text-xs">{{ $i + 1 }}</td>
                        <td class="border border-gray-700 px-3 py-2 font-mono text-xs font-semibold text-blue-700">{{ $entry['asset_code'] ?? '—' }}</td>
                        <td class="border border-gray-700 px-3 py-2 text-gray-200">{{ $entry['asset_description'] ?? '—' }}</td>
                ...
                <tfoot class="bg-gray-900 font-semibold">
                    <tr>
                        <td colspan="7" class="border border-gray-700 px-3 py-2 text-right text-sm">Total Depreciation:</td>
                        <td class="border border-gray-700 px-3 py-2 text-right text-blue-700">{{ number_format($run->total_debit, 2) }}</td>
                    </tr>
                </tfoot>
                @endif
            </table>

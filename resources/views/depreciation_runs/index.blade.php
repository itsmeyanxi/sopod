...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            <h1 class="text-2xl font-bold text-white">DEPRECIATION RUNS</h1>
        ...
        <!-- Filters -->
        <form method="GET" action="{{ route('depreciation_runs.index') }}" class="bg-gray-900 border border-gray-700 rounded-lg p-4 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-3">
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Search run number, description..." class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-sm">
                <input type="month" name="period" value="{{ request('period') }}" class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-sm">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('depreciation_runs.index') }}" class="bg-gray-200 text-gray-200 px-3 py-2 rounded text-sm hover:bg-gray-300"><i class="fas fa-times"></i></a>
                </div>
            </div>
        </form>
            ...
            <table class="w-full text-sm border-collapse">
                <thead class="bg-gray-900 text-gray-500 uppercase text-xs">
                    <tr>
                        ...
                        <th class="border border-gray-700 px-3 py-3 text-center">Assets</th>
                        <th class="border border-gray-700 px-3 py-3 text-right">Total Amount</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-900 border-b border-gray-100">
                        ...
                        <td class="border border-gray-700 px-3 py-2 text-center text-xs font-semibold">{{ $run->period_label }}</td>

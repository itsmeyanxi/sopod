...
<div class="max-w-6xl mx-auto px-6 py-10 bg-gray-50 min-h-screen text-gray-100">
    ...
    <div class="flex items-center space-x-4 mb-8">
        <a href="{{ route('customers.index') }}" class="text-gray-500 hover:text-gray-800 transition">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="{{ route('customers.update', $customer->id) }}" method="POST">
            ...
            <div class="mb-8">
                <h2 class="text-xl font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">Basic Information</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               class="w-full px-4 py-2 rounded-lg bg-gray-100 border border-gray-300 text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>
            ...
            <div class="mb-8">
                <h2 class="text-xl font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">Contact Information</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="mb-8">
                <h2 class="text-xl font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">Address Information</h2>
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <textarea name="billing_address" 
                                  id="billing_address" 
                                  rows="3"
                                  class="w-full px-4 py-2 rounded-lg bg-gray-100 border border-gray-300 text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-transparent">{{ old('billing_address', $customer->billing_address) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="shipping_address" 
                                  id="shipping_address" 
                                  rows="3"
                                  class="w-full px-4 py-2 rounded-lg bg-gray-100 border border-gray-300 text-gray-100 focus:ring-2 focus:ring-indigo-500 focus:border-transparent">{{ old('shipping_address', $customer->shipping_address) }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                <h2 class="text-xl font-bold text-gray-800 mb-4 border-b border-gray-200 pb-2">Financial Information</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">

            ...
            <tbody class="divide-y divide-gray-700 text-gray-300">
                @forelse($customers as $customer)
                    <tr class="hover:bg-gray-700/40 transition">
                        ...
                        <td class="px-4 py-3">{{ $customer->business_style }}</td>
                        <td class="px-4 py-3">{{ $customer->billing_address }}</td>
                        <td class="px-4 py-3">{{ $customer->tin }}</td>
                        <td class="px-4 py-3">{{ $customer->shipping_address }}</td>
                        <td class="px-4 py-3">
                ...
                @empty
                    <tr>
                        <td colspan="{{ auth()->user()->canManageCustomers() ? '9' : '8' }}" 

        ...
        <form method="POST" action="{{ route('loans.update', $loan->id) }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div>
                    ...
                    <select name="loan_type" required class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-sm">
            ...
            <div class="mb-6">
                <label class="block text-sm font-semibold text-gray-300 mb-1">Purpose</label>
                <textarea name="purpose" rows="2" class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-sm">{{ old('purpose', $loan->purpose) }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                ...
                <div>
                    <label class="block text-sm font-semibold text-gray-300 mb-1">Interest Rate (% p.a.) <span class="text-red-500">*</span></label>
                    <input type="number" name="interest_rate" value="{{ old('interest_rate', $loan->interest_rate) }}" required step="0.0001" min="0"
                           class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-300 mb-1">Term (Months) <span class="text-red-500">*</span></label>
            ...
            <h2 class="text-base font-semibold text-gray-300 mb-3 border-b pb-2">GL Account Mapping</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div>
                    ...
                    <textarea name="terms_conditions" rows="3" class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-sm">{{ old('terms_conditions', $loan->terms_conditions) }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-300 mb-1">Remarks</label>
                    <textarea name="remarks" rows="3" class="w-full bg-gray-800 border border-gray-600 rounded px-3 py-2 text-sm">{{ old('remarks', $loan->remarks) }}</textarea>
                </div>
            </div>

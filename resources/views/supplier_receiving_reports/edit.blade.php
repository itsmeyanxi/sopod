...
@section('title', 'Edit Supplier Receiving Report')
...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            <h1 class="text-2xl font-bold text-white">EDIT SUPPLIER RECEIVING REPORT</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="storage" value="{{ old('storage', $report->storage) }}" placeholder="Warehouse / Storage Location"
                            class="w-full bg-gray-900 border border-gray-700 rounded px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-purple-500">
                    </div>
                    <div>

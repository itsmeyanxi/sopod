...
<div class="container mx-auto">
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6 border-b border-gray-200 pb-4">
            <h1 class="text-2xl font-bold text-gray-800">EDIT SUPPLY RECEIVING REPORT</h1>
        ...
        <form action="{{ route('supplier_receiving_reports.update', $report->id) }}" method="POST" id="srrForm">
                        ...
                        <tbody id="itemsBody">
                            ...
                            <tr class="item-row">
                                ...
                                <td class="border border-gray-200 px-1 py-1">
                                    <input type="text" name="items[{{ $index }}][item_code]" value="{{ old("items.{$index}.item_code", $item->item_code) }}" class="w-full bg-gray-50 border-0 px-2 py-1 text-gray-800 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 rounded">
                                </td>
                                <td class="border border-gray-200 px-1 py-1">
                                    <div class="relative">
                                        <input type="text" name="items[{{ $index }}][item_description]" value="{{ old("items.{$index}.item_description", $item->item_description) }}" required class="w-full bg-gray-50 border-0 px-2 py-1 text-gray-800 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 rounded srr-desc-input" autocomplete="off">
                                ...
                                <td class="border border-gray-200 px-1 py-1">
                                    <input type="text" name="items[{{ $index }}][brand]" value="{{ old("items.{$index}.brand", $item->brand) }}" class="w-full bg-gray-50 border-0 px-2 py-1 text-gray-800 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 rounded">
                                </td>
                                <td class="border border-gray-200 px-1 py-1">
                                    <input type="number" name="items[{{ $index }}][no_of_boxes]" value="{{ old("items.{$index}.no_of_boxes", $item->no_of_boxes) }}" min="0" class="w-full bg-gray-50 border-0 px-2 py-1 text-gray-800 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 rounded boxes-input" onchange="calculateTotals()">
                                </td>
                                <td class="border border-gray-200 px-1 py-1">
                                    <input type="number" name="items[{{ $index }}][net_weight]" value="{{ old("items.{$index}.net_weight", $item->net_weight) }}" min="0" step="0.01" class="w-full bg-gray-50 border-0 px-2 py-1 text-gray-800 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 rounded weight-input" onchange="calculateTotals()">
                                </td>
                                <td class="border border-gray-200 px-1 py-1">
                                    <input type="date" name="items[{{ $index }}][pd]" value="{{ old("items.{$index}.pd", $item->pd ? $item->pd->format('Y-m-d') : '') }}" class="w-full bg-gray-50 border-0 px-2 py-1 text-gray-800 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 rounded">
                                </td>
                                <td class="border border-gray-200 px-1 py-1">
                                    <input type="date" name="items[{{ $index }}][expiry_date]" value="{{ old("items.{$index}.expiry_date", $item->expiry_date ? $item->expiry_date->format('Y-m-d') : '') }}" class="w-full bg-gray-50 border-0 px-2 py-1 text-gray-800 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 rounded">
                                </td>
                                <td class="border border-gray-200 px-1 py-1">
                                    <input type="text" name="items[{{ $index }}][pallet_no]" value="{{ old("items.{$index}.pallet_no", $item->pallet_no) }}" class="w-full bg-gray-50 border-0 px-2 py-1 text-gray-800 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 rounded">
                                </td>
                                <td class="border border-gray-200 px-1 py-1">
                                    <input type="text" name="items[{{ $index }}][remarks]" value="{{ old("items.{$index}.remarks", $item->remarks) }}" class="w-full bg-gray-50 border-0 px-2 py-1 text-gray-800 text-sm focus:outline-none focus:ring-1 focus:ring-purple-500 rounded">
                                </td>
            ...
            <div class="mb-6">
                ...
                <textarea name="note" rows="3" placeholder="Additional notes..."
                    class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500">{{ old('note', $report->note) }}</textarea>
            </div>
            ...
            <div class="flex justify-end gap-3 border-t border-gray-200 pt-4">
                <a href="{{ route('supplier_receiving_reports.show', $report->id) }}" class="bg-gray-200 text-gray-800 px-6 py-2 rounded hover:bg-gray-500 transition">
                    Cancel
                </a>

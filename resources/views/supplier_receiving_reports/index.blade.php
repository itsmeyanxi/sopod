            ...
            <table class="w-full border-collapse border border-gray-700">
                <thead class="bg-gray-700 text-gray-500 uppercase text-sm">
                    <tr>
                        ...
                        <th class="border border-gray-700 px-4 py-3">TOTAL WEIGHT</th>
                ...
                <tbody class="text-gray-500">
                    @forelse($reports as $report)
                        <tr class="hover:bg-gray-700/40">
                            ...
                            <td class="border border-gray-700 px-4 py-3">{{ $report->report_date->format('M d, Y') }}</td>
                            <td class="border border-gray-700 px-4 py-3">{{ $report->supplier_name }}</td>
                            <td class="border border-gray-700 px-4 py-3">{{ $report->po_no ?? 'N/A' }}</td>
                            ...
                            <td class="border border-gray-700 px-4 py-3 text-center">{{ $report->items->sum('no_of_boxes') }}</td>
                            ...
                            <td class="border border-gray-700 px-4 py-3">{{ $report->creator->name ?? 'N/A' }}</td>
                            <td class="border border-gray-700 px-4 py-3">

                ...
                <div class="bg-gradient-to-r {{ $isDelivered ? 'from-blue-600 to-blue-700' : ($isCancelled ? 'from-red-600 to-red-700' : 'from-yellow-600 to-yellow-700') }} px-6 py-5">
                    <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <div class="flex items-center gap-4 flex-wrap">
                            <div class="bg-gray-800/20 backdrop-blur-sm rounded-xl px-5 py-3 shadow-lg">
                        ...
                        <div class="flex items-center gap-4">
                            <!-- Item Count -->
                            <div class="bg-gray-800/10 rounded-lg px-4 py-2 backdrop-blur-sm">
                                <div class="text-xs text-blue-100 font-medium">Items</div>
                                <div class="text-lg font-bold text-white">{{ $delivery->items->count() }}</div>
                            </div>

                            <!-- Batch Total -->
                            <div class="bg-gray-800/10 rounded-lg px-4 py-2 backdrop-blur-sm text-right">
                            ...
                            <a href="{{ route('deliveries.show', $delivery->id) }}" 
                               class="bg-gray-800/20 hover:bg-gray-800/30 backdrop-blur-sm text-white px-4 py-2 rounded-lg text-sm font-medium transition-all duration-150 flex items-center gap-2">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

    ...
    <form action="{{ route('sales_orders.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
        ...
        <div class="mb-6">
            ...
            <input 
                ...
                readonly
                class="w-64 bg-white text-gray-800 border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring focus:ring-blue-500"
            >
        </div>

        <!-- ================= CUSTOMER DETAILS SECTION ================= -->
        <div class="bg-white text-gray-800 p-6 rounded-xl shadow-md mb-8">
            <h2 class="text-lg font-semibold mb-4 border-b border-gray-200 pb-1">Customer Information</h2>
        ...
        <div class="mb-4">
            ...
            <div class="relative customer-search-container">
                <div class="relative">
                    <input 
                        ...
                        class="w-full bg-gray-50 border-2 border-gray-200 rounded-lg px-3 py-2 pr-10 text-gray-800 placeholder-gray-500 focus:border-blue-500 focus:outline-none transition-colors"
                ...
                <!-- Dropdown Container -->
                <div id="customer_dropdown" class="absolute z-[9999] w-full bg-white border-2 border-gray-300 rounded-lg mt-1 shadow-2xl hidden max-h-80 overflow-y-auto">
                    <div class="sticky top-0 bg-gray-100 px-3 py-2 text-xs text-gray-500 font-semibold border-b border-gray-300">
                        Select a customer
                    </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" id="customer_name" name="customer_name" readonly
                        class="w-full bg-gray-100 border border-gray-300 text-gray-800 rounded-lg focus:border-blue-500 focus:ring-blue-500" />
                </div>
                <div>
            ...
            <div class="mt-4">
                ...
                <textarea id="additional_instructions" name="additional_instructions" rows="2"
                    class="w-full bg-gray-100 border border-gray-300 text-gray-800 rounded-lg focus:border-blue-500 focus:ring-blue-500"></textarea>
            </div>
        </div>
        ...
        <div class="bg-white p-6 rounded-lg mb-8">
            <h2 class="text-lg font-semibold mb-3 border-b border-gray-200 pb-1">Order Details</h2>
            <div class="grid grid-cols-2 gap-4">
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="branch" name="branch"
                        class="w-full bg-gray-50 text-gray-800 border border-gray-200 rounded px-2 py-1 focus:ring-blue-500 focus:border-blue-500">
                </div>
                ...
                <div class="col-span-2" id="po_image_container" style="display: none;">
                    <div class="bg-yellow-900/20 border-2 border-yellow-700 rounded-lg p-4">
                        ...
                        <div id="po_image_preview" class="mt-3 hidden">
                            <img id="po_image_preview_img" src="" alt="PO Preview" class="max-w-xs rounded border border-gray-200">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- ================= ITEM TABLE ================= -->
        <div class="bg-gray-50 text-gray-800 p-6 rounded-xl mt-8" style="overflow: visible;">
            <h2 class="text-lg font-semibold mb-4 border-b border-gray-200 pb-2">Items <span class="text-red-500">*</span></h2>

            <div style="overflow: visible; position: relative;">
                <table class="min-w-full border border-gray-200 rounded-lg text-left" id="itemsTable" style="position: relative;">
                    <thead class="bg-white text-gray-500">
                        <tr>
                            <th class="px-3 py-2 border border-gray-200" style="position: relative;">Item Description</th>
                            <th class="px-3 py-2 border border-gray-200">Item Code</th>
                            <th class="px-3 py-2 border border-gray-200">Item Category</th>
                            <th class="px-3 py-2 border border-gray-200">Brand</th>
                            <th class="px-3 py-2 border border-gray-200">Quantity</th>
                            <th class="px-3 py-2 border border-gray-200">UOM (kgs)</th>
                            <th class="px-3 py-2 border border-gray-200">Unit Selling Price</th>
                            <th class="px-3 py-2 border border-gray-200">Amount</th>
                            <th class="px-3 py-2 border border-gray-200">Note</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td class="px-2 py-2 border border-gray-200" style="position: relative; overflow: visible;">
                                <div class="relative item-search-container" style="position: relative;">
                                    <div class="relative">
                                        <input 
                                            type="text" 
                                            class="item-search w-full bg-white border-2 border-gray-300 rounded-lg px-3 py-2 pr-10 text-gray-800 placeholder-gray-500 focus:border-blue-500 focus:outline-none transition-colors"
                                    ...
                                    <div class="item-dropdown absolute z-[9999] w-full bg-white border-2 border-gray-300 rounded-lg mt-1 shadow-2xl hidden max-h-80 overflow-y-auto" style="position: absolute; left: 0;">
                                        <div class="sticky top-0 bg-gray-100 px-3 py-2 text-xs text-gray-500 font-semibold border-b border-gray-300">
                                            Select an item
                                        </div>
                            ...
                            <td class="px-2 py-2 border border-gray-200">
                                <textarea 
                                    name="items[0][note]" 
                                    class="item-note w-full bg-white border border-gray-200 rounded-md px-2 py-1 text-gray-800"
                                    rows="1"
...
window.validateForm = function() {
    ...
    return true;
        ...
        document.getElementById("addRowBtn").addEventListener("click", () => {
            ...
            let dropdownHTML = '<div class="sticky top-0 bg-gray-100 px-3 py-2 text-xs text-gray-500 font-semibold border-b border-gray-300">Select an item</div>';
            ...
            newRow.innerHTML = `
                <td class="border border-gray-200 px-2 py-1">
                    <div class="relative item-search-container">
                        ...
                        <div class="item-dropdown absolute z-50 w-full bg-white border-2 border-gray-300 rounded-lg mt-1 shadow-2xl hidden max-h-80 overflow-y-auto">
                            ${dropdownHTML}
                        </div>
                    </div>

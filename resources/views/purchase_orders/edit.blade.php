    ...
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6">
        ...
        <form action="{{ route('purchase_orders.update_notes', $purchaseOrder->id) }}" method="POST" id="notesForm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div class="space-y-2">
                    <p class="text-gray-400"><span class="font-semibold text-gray-300">Company:</span> {{ $purchaseOrder->company }}</p>
                    <p class="text-gray-400"><span class="font-semibold text-gray-300">Order Date:</span> {{ $purchaseOrder->order_date->format('M d, Y') }}</p>
                    <p class="text-gray-400"><span class="font-semibold text-gray-300">PR#:</span> {{ $purchaseOrder->pr_no ?? 'N/A' }}</p>
                </div>
                <div class="space-y-2">
                    <p class="text-gray-400"><span class="font-semibold text-gray-300">Payment Terms:</span> {{ $purchaseOrder->payment_terms ?? 'N/A' }}</p>
                    <p class="text-gray-400"><span class="font-semibold text-gray-300">Status:</span> <span class="text-green-400">Approved</span></p>
                </div>
            </div>

    ...
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex items-center gap-3">
                ...
                @endif
                <a href="{{ route('purchase_orders.create') }}" class="bg-gradient-to-r from-purple-600 to-purple-700 text-gray-800 px-6 py-2 rounded hover:from-purple-700 hover:to-purple-800 transition">
        ...
        <div class="overflow-x-auto">
            <table class="w-full border-collapse border border-gray-200">
                ...
                <tbody class="text-gray-500">
                    ...
                    @empty
                        <tr>
                            <td colspan="{{ auth()->user()->canApprovePurchaseOrders() ? 9 : 8 }}" class="border border-gray-200 px-4 py-8 text-center text-gray-400">

    ...
    <div class="bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="bg-gray-700 rounded-lg p-6 mb-6">
            ...
            <form method="GET" action="{{ route('ar.unified') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <div class="flex items-end">
                    <button type="button" onclick="exportData()" class="w-full bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded font-medium">
        ...
        <div class="flex justify-end gap-3 mb-6">
            ...
            <button type="button" onclick="openAdjustmentModal()" class="bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded font-medium">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="payment_notes" rows="3"
                              class="w-full bg-gray-700 text-white border border-gray-600 rounded px-3 py-2"></textarea>
                </div>
            </div>
...
<div id="adjustment_modal" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-gray-800 rounded-lg p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <button onclick="closeAdjustmentModal()" class="text-gray-400 hover:text-white">
                <i class="fas fa-times text-2xl"></i>
            </button>
        </div>

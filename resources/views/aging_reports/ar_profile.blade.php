    ...
    <div class="bg-gray-800 rounded-lg shadow-lg p-6">
        ...
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            <div>
                ...
                <p class="text-gray-300 text-sm mt-1">Complete AR History: Invoices + Collections + Adjustments</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <p class="text-gray-300 text-xs mt-1">{{ $recordCount ?? 0 }} record(s)</p>
            </div>
        </div>
        @endif
        ...
        <div class="bg-indigo-50 border border-indigo-200 rounded-lg p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-5 gap-6">
                <div class="text-center">
                    <p class="text-gray-300 text-xs mb-2">Starting: Invoices</p>
                    <p class="text-white text-2xl font-bold">₱{{ number_format($financialSummary['original_invoice_amount'], 2) }}</p>
                    <p class="text-gray-300 text-sm mt-1">What they owe</p>
                </div>
                ...
                <div class="text-center">
                    <p class="text-gray-300 text-xs mb-2">Collections</p>
                    ...
                    <p class="text-gray-300 text-xs mt-1">Check: ₱{{ number_format($financialSummary['total_collections'] + $financialSummary['ewt_total'], 2) }}</p>
                    <p class="text-orange-700 text-xs">Less EWT: ₱{{ number_format($financialSummary['ewt_total'], 2) }}</p>
                    @else
                    <p class="text-gray-300 text-sm mt-1">Payments received</p>
                    @endif
                </div>
                ...
                <div class="text-center">
                    <p class="text-gray-300 text-xs mb-2">Adjustments</p>
                    ...
                    <p class="text-gray-300 text-xs mt-1">+ Charges: ₱{{ number_format($financialSummary['total_adjustments_increase'], 2) }}</p>
                    <p class="text-gray-300 text-xs">- Credits: ₱{{ number_format($financialSummary['total_adjustments_decrease'], 2) }}</p>
                </div>
            </div>

            <div class="mt-6 pt-6 border-t border-indigo-200 text-center">
                <p class="text-gray-300 text-sm mb-2">= Current AR Balance</p>
        ...
        <div class="bg-gray-700 rounded-lg p-6 mb-6">
            <div class="flex border-b border-gray-600 mb-4 overflow-x-auto">
                ...
                <button onclick="showTab('ar_records')" id="tab_ar_records" class="tab-button px-6 py-3 text-gray-300 hover:text-white whitespace-nowrap">
                    <i class="fas fa-file-invoice mr-2"></i>Invoices ({{ $recordCount ?? 0 }})
                </button>
                <button onclick="showTab('collections')" id="tab_collections" class="tab-button px-6 py-3 text-gray-300 hover:text-white whitespace-nowrap">
                    <i class="fas fa-money-bill-wave mr-2"></i>Collections ({{ isset($collections) ? count($collections) : 0 }})
                </button>
                <button onclick="showTab('adjustments')" id="tab_adjustments" class="tab-button px-6 py-3 text-gray-300 hover:text-white whitespace-nowrap">
                    ...
                    <table class="min-w-full bg-gray-800 rounded-lg text-xs">
                        ...
                        <tbody class="text-gray-200">
                            ...
                            <tr class="border-b border-gray-700 hover:bg-gray-900">
                                ...
                                <td class="px-3 py-3 text-right font-semibold {{ $trans['debit'] > 0 ? 'text-red-700' : 'text-gray-300' }}">
                                    {{ $trans['debit'] > 0 ? '+₱' . number_format($trans['debit'], 2) : '-' }}
                                </td>
                                <td class="px-3 py-3 text-right font-semibold {{ $trans['credit'] > 0 ? 'text-green-700' : 'text-gray-300' }}">
                    ...
                    <table class="min-w-full bg-gray-800 rounded-lg text-xs">
                        ...
                        <tbody class="text-gray-200">
                            ...
                            <tr class="border-b border-gray-700 hover:bg-gray-900">
                                ...
                                <td class="px-2 py-3 text-right font-bold {{ ($coll['net_ar_balance'] ?? 0) > 0 ? 'text-red-700' : 'text-gray-300' }}">

...
<div class="container mx-auto">
    <div class="bg-gray-800 text-white rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
            ...
            <span class="bg-gray-700 text-gray-500 px-3 py-1 rounded text-sm font-mono">{{ $asset->asset_code }}</span>
        </div>
        ...
        <form action="{{ route('fixed_assets.update', $asset->id) }}" method="POST">
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('fixed_assets.show', $asset->id) }}" class="bg-gray-700 text-white px-6 py-2 rounded hover:bg-gray-200 transition">Cancel</a>

...
<div class="container mx-auto">
    <div class="bg-white text-gray-800 rounded-lg shadow-lg p-6 max-w-4xl mx-auto">
        <div class="flex justify-between items-center mb-6 border-b border-gray-200 pb-4">
            ...
            <span class="bg-gray-100 text-gray-500 px-3 py-1 rounded text-sm font-mono">{{ $asset->asset_code }}</span>
        </div>
        ...
        <form action="{{ route('fixed_assets.update', $asset->id) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea name="asset_description" required rows="2" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">{{ old('asset_description', $asset->asset_description) }}</textarea>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Serial / Engine No.</label>
                    <input type="text" name="serial_engine_no" value="{{ old('serial_engine_no', $asset->serial_engine_no) }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Plate No.</label>
                    <input type="text" name="plate_no" value="{{ old('plate_no', $asset->plate_no) }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Quantity</label>
                    <input type="number" name="quantity" value="{{ old('quantity', $asset->quantity) }}" min="1" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                <div>
                    ...
                    <input type="date" name="acquisition_date" value="{{ old('acquisition_date', $asset->acquisition_date?->format('Y-m-d')) }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Date Posted</label>
                    <input type="date" name="date_posted" value="{{ old('date_posted', $asset->date_posted?->format('Y-m-d')) }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Disposal Date</label>
                    <input type="date" name="disposal_date" value="{{ old('disposal_date', $asset->disposal_date?->format('Y-m-d')) }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Disposal Amount</label>
                    <input type="number" name="disposal_amount" value="{{ old('disposal_amount', $asset->disposal_amount) }}" step="0.01" min="0" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    ...
                    <input type="number" name="cost" value="{{ old('cost', $asset->cost) }}" step="0.01" min="0" required class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Remaining Life (Months)</label>
                    <input type="number" name="remaining_life_months" value="{{ old('remaining_life_months', $asset->remaining_life_months) }}" min="0" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Accumulated Depreciation</label>
                    <input type="number" name="accumulated_depreciation" value="{{ old('accumulated_depreciation', $asset->accumulated_depreciation) }}" step="0.01" min="0" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Status</label>
                    <select name="status" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="assigned_person" value="{{ old('assigned_person', $asset->assigned_person) }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Employee Name</label>
                    <input type="text" name="employee_name" value="{{ old('employee_name', $asset->employee_name) }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-500 mb-1">Vendor</label>
                    <input type="text" name="vendor_name" value="{{ old('vendor_name', $asset->vendor_name) }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <input type="text" name="reference_apv_jv" value="{{ old('reference_apv_jv', $asset->reference_apv_jv) }}" class="w-full bg-gray-50 border border-gray-200 rounded px-3 py-2 text-sm">
                </div>
                <div>
            ...
            <div class="flex justify-end gap-4">
                <a href="{{ route('fixed_assets.show', $asset->id) }}" class="bg-gray-100 text-gray-800 px-6 py-2 rounded hover:bg-gray-200 transition">Cancel</a>

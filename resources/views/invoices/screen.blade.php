    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="bg-gray-100 rounded-lg p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-white rounded-lg p-4 flex flex-col justify-center">
                    <p class="text-gray-400 text-xs mb-1">Week Number</p>
                    <p class="text-gray-800 text-xl font-bold" id="week_number">{{ now()->format('Y') }} - {{ now()->weekOfYear }}</p>
                </div>
                <div class="bg-white rounded-lg p-4 flex flex-col justify-center">
                    <p class="text-gray-400 text-xs mb-1">Week Beginning Date</p>
        ...
        <div id="dashboard_content" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4" id="summary_cards">
                <div class="bg-gradient-to-br from-blue-900/40 to-blue-800/30 border border-blue-700/50 rounded-lg p-6">
                    <div class="flex items-center justify-between mb-2">
                        <h3 class="text-sm font-semibold text-blue-300">Total Records</h3>
                ...
                <div class="bg-gradient-to-br from-green-900/40 to-green-800/30 border border-green-700/50 rounded-lg p-6">
                    <div class="flex items-center justify-between mb-2">
                        <h3 class="text-sm font-semibold text-green-300">Outstanding AR</h3>
                ...
                <div class="bg-gradient-to-br from-purple-900/40 to-purple-800/30 border border-purple-700/50 rounded-lg p-6">
                    <div class="flex items-center justify-between mb-2">
                        <h3 class="text-sm font-semibold text-purple-300">Total AR</h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <button type="button" id="view_summary_btn" class="bg-gradient-to-br from-indigo-900/40 to-indigo-800/30 border border-indigo-700/50 rounded-lg p-4 hover:bg-indigo-800/50 transition">
                            <div class="flex items-center justify-between mb-2">
                                <i class="fas fa-table text-indigo-400 text-2xl"></i>
                                <span class="text-xs text-indigo-300 font-semibold">VIEW</span>
                            </div>
            ...
            <div class="flex justify-end gap-3">
                <button type="button" id="export_summary_btn" class="bg-emerald-600 hover:bg-emerald-700 text-gray-800 px-6 py-2 rounded font-medium transition">
    ...
    function updateAgingBreakdown(totals) {
        const breakdownHTML = `
            ...
            <div class="bg-gradient-to-r from-blue-900/50 to-purple-900/50 rounded-lg p-4 flex justify-between items-center border-2 border-blue-500">
                <div>
                    <p class="text-blue-300 text-sm font-semibold">Total</p>
                    <p class="text-gray-800 text-3xl font-bold">${formatCurrency(totals.total)}</p>
                </div>
                <i class="fas fa-calculator text-blue-400 text-3xl"></i>
            </div>
        `;
